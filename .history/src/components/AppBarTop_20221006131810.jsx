...
const useStyles = makeStyles({
  ...
  boxContainer: {
    width: "1.5rem",
    height: "1.1rem",
    border: `2.7px solid ${colors_m.darkBluelv_1}`,
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    borderRadius: ".1rem",
  ...
  leftBorder: {
    ...
    height: "80%",
    marginLeft: ".1rem",
    borderLeft: `2.7px solid ${colors_m.darkBluelv_1}`,
  },
  middleBorder: {
    width: "80%",
    height: "100%",
    marginBottom: ".3rem",
    borderBottom: `2.7px solid ${colors_m.darkBluelv_1}`,
  },
  rightBorder: {
    width: "100%",
    height: "80%",
    marginRight: ".1rem",
    borderRight: `2.7px solid ${colors_m.darkBluelv_1}`,
  },
});
const IconGit = () => {
  return (
